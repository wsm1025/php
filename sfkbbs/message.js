...
function(o, e) {
	"object" === ("undefined" == typeof exports ? "undefined": _typeof(exports)) && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (o = o || self, o.cocoMessage = e())
} (void 0,
function() {
	function o(o, e) {
		...
		for (var s in o) {
			var a = o[s];
			"className" == s ? (s = "class", t.setAttribute(s, a)) : "_" == s[0] && t.addEventListener(s.slice(1), a)
		}
		if ("string" == typeof e) t.innerHTML = e;
		else if ("object" == _typeof(e) && e.tagName) t.appendChild(e);
		else if (e) for (var r = 0; r < e.length; r++) {
			var c = e[r];
			t.appendChild(c)
		}
		return t
	}
	function e(o, e) { ["a", "webkitA"].forEach(function(t) {
			var s = t + "nimationEnd";
	...
	function c(o, e) {
		var t = {};
		for (var s in h) t[s] = h[s];
		for (var a = 0; a < o.length; a++) {
			var r = o[a];
			void 0 !== r && ("string" == typeof r || "object" == _typeof(r) ? t.msg = r: "boolean" == typeof r ? t.showClose = r: "function" == typeof r ? t.onClose = r: "number" == typeof r && (t.duration = r))
		}
		return t.type = e,
		n(t)
	}
	function n(s) {
		...
		m = 0 === c,
		h = l();
		"loading" == a && (n = "" === n ? "正在加载，请稍后": n, m = d, c = 0);
		var u = o({
			className: "coco-msg-wrapper"
		},
		[o({
			className: "coco-msg coco-msg-fade-in " + a
		},
		[o({
		...
		n), o({
			className: "coco-msg-wait " + (m ? "coco-msg-pointer": ""),
			_click: function() {
				m && f(u, g)
			}
		},
		i(m))])]),
		b = u.querySelector(".coco-msg__circle");
		if (b && (t(b, {
			animation: "coco-msg_" + a + " " + c + "ms linear"
		}), "onanimationend" in window ? e(b,
		function() {
			f(u, g)
		}) : setTimeout(function() {
			f(u, g)
		},
		c)), "loading" == a && 0 !== c && setTimeout(function() {
			f(u, g)
		},
		c), p.children.length || document.body.appendChild(p), p.appendChild(u), t(u, {
			height: u.offsetHeight + "px"
		}), setTimeout(function() {
			r(u.children[0], "coco-msg-fade-in")
		},
		300), "loading" == a) return function() {
			f(u, g)
		}
	}
	function i(o) {
	...
	function f(o, e) {
		o && (t(o, {
			padding: 0,
			height: 0
		}), s(o.children[0], "coco-msg-fade-out"), e && e(), setTimeout(function() {
			if (o) {
				for (var e = !1,
				t = 0; t < p.children.length; t++) p.children[t] === o && (e = !0);
				e && d(o),
				o = null,
				p.children.length || e && d(p)
			}
		},
		300))
	}
	...
	u = {
		...
		config: function(o) {
			for (var e in o) Object.hasOwnProperty.call(o, e) && void 0 !== o[e] && (h[e] = o[e])
		}
	};
